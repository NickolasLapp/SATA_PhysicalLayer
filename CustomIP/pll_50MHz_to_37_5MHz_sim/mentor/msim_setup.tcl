...
# # End of template
# ----------------------------------------
# If pll_50MHz_to_37_5MHz is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 193 win32 2017.03.08.23:20:13
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "pll_50MHz_to_37_5MHz"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_50MHz_to_37_5MHz.vho"
}
